...
export default function Comments() {
  ...
  // Helper function to render connecting lines
            ...
            <div key={category.id} className="mb-2">
              ...
              {category.expanded &&
                category.children.map((subCategory, subIndex) => {
                  ...
                  return (
                    <div key={subCategory.id} className="ml-4.5 py-0 relative">
                      ...
                      <div className="flex items-center justify-between px-0 py-2 rounded hover:bg-gray-300/30">
                        ...
                        {subCategory.specialities.length > 0 && (
                          <div className="flex items-center">
                        ...
                        <div className="ml-4 relative">
                          ...
                          {subCategory.specialities.map(
                            (speciality, specIndex) => {
                              ...
                              const hasDoctors = speciality.doctors.length > 0;
